...
public class JsonHelper {
    public static BiotechRecipeEntity getRecipeEntityFromJson(JsonObject pSerializedRecipe) {
        Gson gson = new Gson();
        ...
        return new BiotechRecipeEntity(itemIngredients, ingredientsConsumable, itemResults, fluidIngredients, fluidResults, totalEnergy);
    }
