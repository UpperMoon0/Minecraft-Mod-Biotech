...
public class BiotechRecipe implements Serializable {
    ...
    public BiotechRecipe(ItemStack[] inputs, boolean[] isInputConsumed, ItemStack[] outputs, FluidStack[] fluidInputs, FluidStack[] fluidOutputs, int totalEnergy) {
    ...
    public static BiotechRecipe fromBuf(FriendlyByteBuf buf) {
