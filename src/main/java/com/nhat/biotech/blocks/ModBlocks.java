...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BREEDING_CHAMBER = BLOCKS.register(RBuildings.BREEDING_CHAMBER_ID, BreedingChamberBlock::new);
    ...
    public static final RegistryObject<Block> TERRESTRIAL_HABITAT = BLOCKS.register(RBuildings.TERRESTRIAL_HABITAT_ID, TerrestrialHabitatBlock::new);
}